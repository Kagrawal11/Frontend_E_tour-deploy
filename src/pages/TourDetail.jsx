      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="relative rounded-3xl overflow-hidden shadow-2xl mb-10 h-[400px] flex items-center justify-center animate-fade-in">
          ...
          <div className="relative z-10 text-center text-white px-4">
            ...
            <p className="text-xl md:text-2xl font-light text-slate-300 drop-shadow-md">
        ...
        <div className="mt-12">
          <h2 className="text-2xl font-bold text-slate-100 mb-6 pl-2 border-l-4 border-[#7c5cff]">Available Departures</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {tour.departures?.length > 0 ? (
              tour.departures.map((dep) => (
                <div key={dep.id || dep.departureId} className="card card-hover p-6 transition-shadow group">
